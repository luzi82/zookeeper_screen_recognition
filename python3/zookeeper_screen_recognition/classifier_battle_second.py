...
class BattleSecondClassifier:
    ...
    def __init__(self, model_path):
        ...
        self.model = classifier_battle_second_model.create_model(len(self.data['label_list']))
...
if __name__ == '__main__':
    ...
    sc = BattleSecondClassifier(MODEL_PATH)
